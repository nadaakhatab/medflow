...
class TestDay3GroundedGeneration(unittest.TestCase):
    ...
    def setUp(self):
        self.sample_chunks = [
            Document(
                page_content="Hypothyroidism is treated by replacing the missing thyroid hormone with synthetic thyroxine pills.",
                metadata={
    ...
    def test_schema_valid_and_invalid(self):
        good = {
            "recommendation": "Use thyroid hormone replacement with synthetic thyroxine pills.",
